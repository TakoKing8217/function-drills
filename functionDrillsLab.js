...
*/
const exclaim2 = (str) => `${str.toUpperCase()} !!!`;
////////////////// PROBLEM 9 ////////////////////
...
let nameGreeting = nameCheck("Nate");
...
//CODE HERE
const thatsOdd = (num) =>
  num % 2 === 0 ? "That's not odd!" : "That's odd indeed!";
...
//CODE HERE
const bestMovie = (param) => `${param} is the best movie ever!`;
